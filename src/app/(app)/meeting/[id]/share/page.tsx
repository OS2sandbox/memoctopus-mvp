...
export default function SharePage() {
  ...
  return (
    <div className="mx-auto max-w-[720px] px-4 py-8">
      <h1 className="text-xl font-semibold text-[var(--ink)] mb-2">Eksportér referat</h1>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-[var(--radius-lg)] border border-[var(--line)] bg-[var(--surface)] p-6">
          ...
          <h2 className="font-semibold text-[var(--ink)] mb-1">PDF-dokument</h2>
        ...
        <div className="rounded-[var(--radius-lg)] border border-[var(--line)] bg-[var(--surface)] p-6">
          ...
          <h2 className="font-semibold text-[var(--ink)] mb-1">Word-dokument</h2>
          <p className="text-sm text-[var(--muted)] mb-4">
      ...
      <div className="mt-8 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--surface-2)] px-4 py-3 text-sm text-[var(--muted)]">
        <strong className="font-medium text-[var(--ink-2)]">Bemærk:</strong> Det eksporterede
