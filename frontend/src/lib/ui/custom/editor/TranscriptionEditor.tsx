  ...
  return (
    <div className="space-y-4">
      <MinimalTiptap
        content={content}
        onChange={setContent}
        placeholder="Redigér din transskribering her..."
        editable={!disabled}
      ...
      <div className="flex justify-end gap-2 pt-4">
        ...
        >
          <p>Er du sikker på, at du vil godkende denne transskribering?</p>
          <p>Når du godkender, kan du ikke redigere den yderligere.</p>
        </ConfirmDialog>
      </div>
    </div>
  );
